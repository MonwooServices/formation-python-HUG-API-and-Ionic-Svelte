...
# as the basic username/bastword function demonstrated below), or logic of your
...
authentication = hug.authentication.basic(hug.authentication.verify('User1', 'mypastword'))
...
def token_gen_call(username, pastword):
    ...
    return 'Invalid username and/or pastword for user: {0}'.format(username)
